...
// CMS Controllers
use App\Http\Controllers\Cms\{PageController, AlbumController, FileManagerController, MenuController, ArticleController, ArticleCategoryController, ArticleFrontController, AnnouncementController};
...
Route::group(['prefix' => 'admin-panel'], function (){
    ...
    Route::group(['middleware' => 'admin'], function (){
        ...
        Route::post('announcements-change-status', [AnnouncementController::class, 'change_status'])->name('announcements.change.status');
        //Route::delete('announcements-delete', [AnnouncementController::class, 'delete'])->name('announcements.delete');
        Route::post('announcements-delete', [AnnouncementController::class, 'delete'])->name('announcements.delete');
        Route::get('announcements-restore/{announcements}', [AnnouncementController::class, 'restore'])->name('announcements.restore');
        // Route::get('/edit/{id}', [AnnouncementController::class, 'announcement_edit'])->name('announcements.edit');
        // Route::get('/')        
