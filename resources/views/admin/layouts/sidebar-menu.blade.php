<ul class="nav nav-aside">
    ...
    @endif
        ...
        <li class="nav-item with-sub @if (request()->routeIs('news*') || request()->routeIs('news-categories*')) active show @endif">
            <a href="" class="nav-link"><i data-feather="edit"></i> <span>Announcements</span></a>
            <ul>
     
                    <li @if (\Route::current()->getName() == 'announcements.index' || \Route::current()->getName() == 'announcements.edit') class="active" @endif><a href="{{ route('announcements.index') }}">Manage Announcements</a></li>
                    <li @if (\Route::current()->getName() == 'announcements.create') class="active" @endif><a href="{{ route('announcements.create') }}">Create Announcement</a></li>
