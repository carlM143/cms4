...
<div class="container pd-x-0">
    <div class="d-sm-flex align-items-center justify-content-between mg-b-20 mg-lg-b-25 mg-xl-b-30">
        <div>
            ...
            <h4 class="mg-b-0 tx-spacing--1">Create Announcement</h4>
        </div>
    </div>
        ...
        <div class="row row-sm">
            <div class="col-lg-6">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control @error('msg') is-invalid @enderror" name="msg" rows="4" required @htmlValidationMessage({{__('standard.empty_all_field')}})>{{ old("msg") }}</textarea>
                    @error('msg')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
