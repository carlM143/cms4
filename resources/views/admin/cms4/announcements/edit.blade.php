...
<div class="container pd-x-0">
        ...
        <div>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-style1 mg-b-10">
                    ...
                    <li class="breadcrumb-item" aria-current="page"><a href="{{route('announcements.index')}}">News</a></li>
    ...
    <form id="editForm" method="post" action="{{ route('announcements.update',['announcement' => $announcement->id]) }}" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        <div class="row row-sm">
            <div class="col-lg-6">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('name') is-invalid @enderror" maxlength="150"  name="name" id="name" value="{{ old('name',$announcement->name) }}" required>
                    @error('name')
                ...
                <div class="form-group">
                    ...
                    <input type="date" class="form-control @error('date') is-invalid @enderror" name="date" id="date" required value="{{ old('date',$announcement->date) }}">
                    @error('date')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
